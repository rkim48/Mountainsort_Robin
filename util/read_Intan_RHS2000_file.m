function [amplifier_data,amplifier_channels,frequency_parameters,board_adc_data]=read_Intan_RHS(name,selectedChs)
...
if (data_present)
    ...
    for i=1:num_data_blocks
        ...
        if (num_amplifier_channels > 0)
             test= fread(fid, [num_samples_per_data_block, num_amplifier_channels], 'uint16')';
            amplifier_data(:, amplifier_index:(amplifier_index + num_samples_per_data_block - 1)) = test(selectedChs,:);
            if (dc_amp_data_saved ~= 0)
